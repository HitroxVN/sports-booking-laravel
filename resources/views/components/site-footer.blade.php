...
================================================================= --}}
<footer class="bg-primary-800 dark:bg-zinc-950 text-white/80 mt-20">
    ...
    {{-- Đệm chân trang: chừa-height cho dải marquee cố định đáy màn hình --}}
    <div class="h-10 bg-primary-800 dark:bg-zinc-950" aria-hidden="true"></div>
</footer>