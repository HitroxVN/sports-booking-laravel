                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800 text-zinc-700 dark:text-zinc-300">
                        ...
                        <tr>
                            <td colspan="6" class="p-8">
                                <x-empty-state icon="⚽" title="Khu sân này chưa có sân con nào" description="Thêm sân con đầu tiên để bắt đầu bán khung giờ." actionUrl="{{ route('owner.venues.courts.create', $venue) }}" />
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
